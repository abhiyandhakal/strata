...
fn default_style_recipes() -> BTreeMap<String, ThemeRecipe> {
    BTreeMap::from([
        ...
        ("editor.cursor_line".to_string(), recipe("white", None, &["reversed"])),
        ("editor.cursor.normal".to_string(), recipe("reset", None, &["reversed"])),
        ("editor.cursor.insert".to_string(), recipe("lightblue", None, &["reversed"])),
        ("editor.cursor.visual".to_string(), recipe("lightyellow", None, &["reversed"])),
        ("editor.cursor.operator".to_string(), recipe("lightgreen", None, &["reversed"])),
